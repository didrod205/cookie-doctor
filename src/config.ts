...
export const DEFAULT_CONFIG: Config = {
  ignore: [],
  sessionNames: ["session", "sess", "sid", "auth", "token", "jwt", "sso", "login", "remember"],
  maxAgeDays: 30,
  minScore: 0,
};

export const CONFIG_FILENAMES = ["cookie-doctor.config.json", ".cookiedoctorrc.json", ".cookiedoctorrc"];
